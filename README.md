...
1. What are the main differences between a class-based and a functional component?
  ...
  Unlike functional components, which uses things like useEffect to control reactions, class-based components allow us to tap into the component lifecycle and give us control over how our components work and when to use them.

2. When does a componentWillMount function be called? What about a componentDidUpdate?

  componentWillMount triggers before the initial render, and componentDidUpdate triggers after state has been changed or updates are made. 

3. Define stateful logic.

  It is logic that is built into a component. It allows you to control reactions based on user-input and other changes that may occur.
  
4. What are the three step of creating a successful test? What is done in each phase? 
  
  Arrange: This is where you render your item or 'arrange' for it to be tested. 
  
  Act: Check for things you expect to see in the browser and that your inputs are working correctly.

  Assert: This is where you test for expected outcomes, often based on the reactions you triggered in the 'act' stage. 
